      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start">
        ...
        <div class="lg:col-span-7">
          <div class="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 lg:mb-8 gap-3 sm:gap-0">
              <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Cistella</h1>
            ...
            <div v-if="cartItems.length === 0" class="text-center py-12 sm:py-16">
              ...
              <h3 class="text-lg sm:text-xl font-medium text-gray-900 mb-2">El teu carret està buit</h3>
              <p class="text-gray-500 mb-6 sm:mb-8 text-sm sm:text-base px-4">Descobreix els nostres productes i afegeix-los al carret</p>
              <Link
        ...
        <div class="mt-8 lg:mt-0 lg:col-span-5">
          <div class="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 lg:sticky lg:top-8">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Resum de la Comanda</h2>
            ...
            <div class="space-y-3 sm:space-y-4">
              ...
              <div class="flex justify-between items-center py-2">
                <span class="text-gray-600 text-sm sm:text-base">Enviament</span>
